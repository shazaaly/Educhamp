                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                            <div class="course-detail-bx">
                                <div class="course-price">
                                    ...
                                    <h4 class="price">${{$course->price_after}}</h4>
                                </div>
                                ...
                                <div class="cours-more-info">
                                    <div class="review">
                                        ...
                                        <ul class="cours-star">
                                            ...
                                            <li Categoriesclass="active"><i class="fa fa-star"></i></li>
                                            <li class="active"><i class="fa fa-star"></i></li>
                                    ...
                                    <div class="price categories">
                                        <span>Stage</span>
                                        <h5 class="text-primary">{{$stage_name}} {{$stage_class}}</h5>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-4">
                                        <ul class="course-features">
                                            <li><i class="ti-book"></i> <span class="label">Lessons</span> <span
                                                    class="value">{{$lessonsCount}}</span></li>
                            ...
                            <div class="" id="instructor">
                                ...
                                <div class="instructor-bx">
                                    ...
                                    <div class="instructor-info">
                                        ...
                                        <p class="m-b0">{{$teacher->long_description}}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
